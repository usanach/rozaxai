...
var data = [
    {
        ...
        data: [
            ...
            },
            {
                ...
                description2: {
                    ...
                    3: ['ปรุงรสด้วยซอสสารพัดผัดปรุงสำเร็จตราโรซ่า',
                        'เชฟแอทโฮมผัดให้เข้ากัน'],
        ...
        data: [
            {
                ...
                description2: {
                    ...
                    3: ['ปรุงรสด้วยซอสสารพัดผัดปรุงสำเร็จตราโรซ่า',
                        ' เชฟแอทโฮม ผัดจนหอม'],
                    4: ['ปิดไฟตักเสิร์ฟใส่ภาชนะที่เตรียมไว']
                }
            },
        ]
    }, {
        ...
        data: [
            {
                ...
                description2: {
                    1: ['ตั้งกระทะไฟกลางใส่น้ำมัน กระเทียม และเนื้อไก', 'ลงไปผัดให้สุกเล็กน้อย'],
        ...
        data: [{
            ...
            description2: {
                ...
                3: ['ปรุงรสด้วยซอสสารพัดผัดปรุงสำเร็จตราโรซ่าเชฟ',
                    'เชฟแอทโฮมผัดให้เข้ากันโรยด้วยพริกไทยเล็กน้อย'],
                4: ['ปิดไฟตักเสิร์ฟใส่ภาชนะที่เตรียมไว้ ']
            }
        },
        ]
        ...
        data: [
            {
                ...
                description1:
                    [
                        ...
                        'ซอสสารพัดผัดปรุงสำเร็จ 3 ช้อนโต๊ะ',
                ...
                description2: {
                    ...
                    3: ['ปรุงรสด้วยซอสสารพัดผัดปรุงสำเร็จ ตราโรซ่า', 'เชฟแอทโฮมผัดคลุกเคล้าให้เข้ากัน',],
        ...
        data: [
            {
                ...
                description1:
                    [
                        'เห็ดรวม 80 กรัม',
                        'ซอสสารพัดผัดปรุงสำเร็จตราโรซ่าเชฟแอทโฮม 1ช้อนโต๊ะ',
                        'กุ้งสด 3 ตัว ',
                        'แครอทขูด 2ช้อนโต๊ะ ',
                        'ต้นหอมท่อน 1ช้อนโต๊ะ',
                        'น ้ามันพืช 1ช้อนโต๊ะ',
                        'พริกไทยเล็กน้อย ',
                        'น ้าเปล่าเล็กน้อย'
                    ],
                description2: {
        ...
        data: [{
            ...
            description1:
                [
                    'วุ้นเส้น 60 กรัม',
                    'ซอสสารพัดผัดปรุงสำเร็จ ตราโรซ่า เชฟแอทโฮม 1 ช้อนโต๊ะ',
                    'กุ้งผ่าหลัง 3 ตัว ', 'กะกล่ำปลี + แครอทลวก 40 กรัม',
                    'กระเทียม 1 ช้อนชา',
                    ' ไข่ไก่ 1 ฟอง',
        ...
        data: [{
            ...
            description1:
                [
                    ...
                    'ซอสสารพัดผัดปรุงสำเร็จ 2 ช้อนโต๊ะ',
                    'น้ำเปล่า 2 ช้อนโต๊ะ',
